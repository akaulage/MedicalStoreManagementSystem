...
Statement s;
 boolean b=true;
JLabel c1,c2,c3,c4;
String medname,billid,sep="-",medicine="",price="",qty="",exp="";
int y,total,grandtotal=0,quantity;
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                                ...
                                                .addComponent(txtExp, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))))))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(303, 303, 303)
    ...
    private void btaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btaddActionPerformed
        ...
        else
        {
         ...
         try{   
                 ...
                 exp=exp.concat(txtExp.getText()).concat(",");
         
                if(b)
                {
                    receipt.append("\t  KONHERI NAVNIRMAN SANGH MEDICAL STORE\n\n"
                        +"\n--------------------------------------------------------------------------------------\n"
                            +"Customer Name: "+txtcusname.getText()+"\t\t   "+"Date: "+ldate.getText()
                        +"\n--------------------------------------------------------------------------------------\n"
                       +"Medicine Name"+"\t\t"+"Quantity"+"\t"+"Price"+"\t"+"Product Exp"+"\t"+"Total");
                    
                    receipt.append("\n"
                        +txtmedname.getText()+"\t\t"+txtqty.getText()+"\t"+txtmedprice.getText()+"\t"+txtExp.getText()+"\t"+total);
        ...
        try
    {
        ...
        ps.setString(11,txtExp.getText());
        ps.executeUpdate();
